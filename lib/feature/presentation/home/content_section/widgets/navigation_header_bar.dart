...
class ContentSectionNavigationHeaderBar extends StatefulWidget {
  const ContentSectionNavigationHeaderBar({super.key});

  @override
  State<ContentSectionNavigationHeaderBar> createState() =>
      _ContentSectionNavigationHeaderBarState();
}

class _ContentSectionNavigationHeaderBarState extends State<ContentSectionNavigationHeaderBar> {
  @override
